        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <p className="mt-4 text-center text-xs text-gray-500">
              Social sign-in is not configured yet. Please use email and password.
            </p>
            <div className="mt-3 grid grid-cols-2 gap-3">
              <button type="button" disabled title="Google sign-in is not configured" className="w-full inline-flex justify-center py-2 px-4 border border-gray-200 rounded-md bg-gray-100 text-sm font-medium text-gray-400 cursor-not-allowed">
              ...
              <button type="button" disabled title="Twitter sign-in is not configured" className="w-full inline-flex justify-center py-2 px-4 border border-gray-200 rounded-md bg-gray-100 text-sm font-medium text-gray-400 cursor-not-allowed">
